...
let authorsArray = Object.entries(otherProps["wp:author"]);
...
let categoriesArray = Object.entries(otherProps["wp:category"]);
const categories = (categoriesArray|| []).map((a) => {
  return {
...
let tagsArray = Object.entries(otherProps["wp:tag"]);
const tags = (tagsArray || []).map((a) => {
  return {
    id: _get(a, ["wp:term_id"]),
